...
V = [[0,0],[4,0],[4,2],[0,2]]
FV = [[0,1,2,3]]
panchina2dSopra = STRUCT(MKPOLS([V,FV]))
panchina3dSopra = PROD([panchina2dSopra,Q(1)])

model = larRod([.25,2.])([32,1])
zampa = STRUCT(MKPOLS(model))

panchinaRovesciata = STRUCT([T([1,2])([1,1])(zampa),T([1,2])([3,1])(zampa),panchina3dSopra])
panchina = T([1,2])([-16,20])(COLOR([0.80,0.75,0.77])(T(3)(2)(R([2,3])(PI)(panchinaRovesciata))))

model = larRod([.25,10.])([32,1])
gamba = STRUCT(MKPOLS(model))

modelluce = larBall(1)([18,36])
luce = T(3)(10)(STRUCT(MKPOLS(modelluce)))

lampioneParziale = STRUCT([COLOR([1,1,0])(luce),COLOR([0,0,0])(gamba)])
lampione1 = T([1,2])([-11,19])(lampioneParziale)
lampione2 = T([1,2])([13,19])(lampioneParziale)
lampione3 = T([1,2])([-13,-14])(lampioneParziale)
lampione4 = T([1,2])([13,-14])(lampioneParziale)
lampioni = STRUCT([lampione1,lampione2,lampione3,lampione4])


vertici = [[0,0],[3,0],[1.5,3]]
celle = [[0,1,2]]
triangolo = STRUCT(MKPOLS([vertici,celle]))
triangolo1 = T(1)(-3.5)(triangolo)
triangolo2 = T(1)(3.5)(triangolo)

treTriangoli = STRUCT([triangolo,triangolo2,triangolo1])

triangoliOK = T([1,2])([-43,-23])(S([1,2])([0.3,0.3])(treTriangoli))

vertici = [[0,0],[2,0],[2,3],[0,3]]
celle = [[0,1,2,3]]
striscia = STRUCT(MKPOLS([vertici,celle]))
striscia1 = T(1)(-3.5)(striscia)
striscia2 = T(1)(3.5)(striscia)

strisciaPedonali = STRUCT([striscia,striscia2,striscia1])
strisciaPedonaliOK = T([1,2])([-43,23])(S([1,2])([0.3,0.3])(strisciaPedonali ))

modeltronco = larRod([0.75,10.])([32,1])
tronco = STRUCT(MKPOLS(modeltronco))

modelchioma = larBall(3)([18,36])
chioma= STRUCT(MKPOLS(modelchioma))

albero = R([2,3])(PI)(T(3)(-10)(STRUCT([COLOR([0.36,0.25,0.2])(tronco),COLOR([0.18,0.54,0.34])(chioma)])))
albero1 = T([1,2])([-47,47])(albero)
albero2 = T([1,2])([-13,-22])(albero)
albero3 = T([1,2])([-47,-22])(albero)
...
battistero3d = STRUCT([pareti,tetti,basi3D,pavimento,stradaPrincipale,stradaSecondaria,stradaTerziaria,stradaUnione,stradaUnionedue,edifici,panchina,lampioni,triangoliOK,strisciaPedonaliOK,boschetto])
VIEW(battistero3d)
